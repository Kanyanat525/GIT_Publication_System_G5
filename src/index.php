...
<header class="bg-white header-shadow sticky top-0 z-50">
   ...
   focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50">
    โปรไฟล์
                    ...
                    <a href="logout.php" class="px-4 py-1.5 font-semibold text-white bg-red-600 border border-red-600 rounded-lg 
                                      transition duration-150 ease-in-out hover:bg-red-700 hover:border-red-700 
