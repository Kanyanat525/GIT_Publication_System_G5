...
<?php
  ...
  if ($uploaded_ok):
      ...
      if ($target_status === 'approved') {
          ...
          $status_html = '<span class="font-semibold text-red-700">ไม่อนุมัติ</span>';
      } else {
...
<footer class="max-w-6xl mx-auto px-4 pb-8">
  <div class="mt-4 rounded-lg bg-blue-100/80 px-4 py-2">
    <nav class="flex items-center justify-end text-blue-700 text-[15px]">
      ...
      <a href="suggestion.php?uid=<?= (int)$user['UID'] ?>"
         class="flex items-center gap-2 hover:underline focus:outline-none focus:ring-2 focus:ring-blue-300 rounded">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8">
          <path stroke-linecap="round" stroke-linejoin="round"
            d="M8 10h8M8 14h5M7 20l3.5-3H18a3 3 0 0 0 3-3V7a3 3 0 0 0-3-3H6a3 3 0 0 0-3 3v7a3 3 0 0 0 3 3h.5" />
        </svg>
        <span class="font-medium">เสนอแนะเกี่ยวกับระบบ</span>
      </a>

      <span class="mx-3 h-5 w-px bg-blue-300" aria-hidden="true"></span>

      <!-- คู่มือการใช้งาน -->
      <a href="User_manual.php?uid=<?= (int)$user['UID'] ?>"
         class="flex items-center gap-2 hover:underline focus:outline-none focus:ring-2 focus:ring-blue-300 rounded">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 rotate-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8">
          <path stroke-linecap="round" stroke-linejoin="round"
            d="M7 7h7a4 4 0 0 1 4 4v6M17 17l-3-3m3 3l-3 3" />
        </svg>
        <span class="font-medium">คู่มือการใช้งาน</span>
      </a>
      ...
      <a href="lecturer_edit_history.php?uid=<?= (int)$user['UID'] ?>"
        ...
        <span class="font-medium">ประวัติการแก้ไข</span>
      </a>
    </nav>
  </div>
</footer>
